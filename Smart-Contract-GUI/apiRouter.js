...
const listingModel = require('./Server/Xeries/models/listing');
const userModel = require('./Server/Xeries/models/users');
...
apiRouter.use("/real-t/", RealTRouter);
apiRouter.use("/xeries/", XeriesRouter);
apiRouter.use("/copyright/", CopyrightRouter);
