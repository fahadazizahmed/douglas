...
function EditablePDF() {
  ...
  const handleOpenLink = () => {
    window.open(`${config.pdfUrl}/${document}`, '_blank');
  ...
  return (
    ...
    <div className="limiter">
      <Navbar />
      {console.log("LRLRLRLRL", `${config.backendURL}/doc/${documentReceoive}`)}
          ...
          <form className="login100-form validate-form">
            ...
            >
              ...
              <div style={{ marginTop: 12 }}>
                <iframe src={`${config.backendURL}/doc/${documentReceoive}`} width="100%" height="200px"></iframe>
              </div>
