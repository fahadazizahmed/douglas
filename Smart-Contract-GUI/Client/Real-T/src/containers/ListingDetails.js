            ...
            <div className="mv-3 row justify-content-centerw-75">
              <div className="w-100 text-center m-3">
                <img
                  ...
                  src={`${config.backendURL}/api/${listingData.item.image}`}
              ...
              <div className="row w-100">
                ...
                {listingData.item.zillowLink && (
                  <ListItem className={classes.listItem}>
                    <a
                      target="__blank"
                      href={listingData.item.zillowLink}
                    >
                      <ListItemText primary="View on Zillow" />
                    </a>
                  </ListItem>
                )}
                  ...
                  ${listingData.item.owner?.surname}`}
                    ...
                    {/* <div className="pb-3">
                      <p>
                        ...
                        <NavLink
                          to={`/real-t/${listingData.item.owner.username}`}
                        >
                          click here
                        </NavLink>
                      </p>
